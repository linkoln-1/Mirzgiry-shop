        ...
        <div className={s.header__container}>
          ...
          <div className={s.header_logo_language}>
            <div className={s.header_logo}>
              <NavLink
                className={colorPlace ? `${s.red}` : `${s.link}`}
                onClick={() => setColorPlace(false)}
                to="/"
              >
                Mirzgiry
              </NavLink>
          ...
          <div className={s.header_functional}>
            <div className={s.icon}>
              ...
              <NavLink to="/search" onClick={() => setColorPlace(true)}>
                <svg
                  className={colorPlace ? `${s.iconblack}` : `${s.icon}`}
                  width="25"
                  height="25"
            ...
            <div>
              <NavLink to="/personal" onClick={() => setColorPlace(true)}>
                <svg
                  className={colorPlace ? `${s.iconblack}` : `${s.icon}`}
                  width="20"
                  height="25"
            ...
            <div>
              <NavLink to="/basket" onClick={() => setColorPlace(true)}>
                <svg
                  className={colorPlace ? `${s.iconblack}` : `${s.icon}`}
                  width="25"
                  height="25"
