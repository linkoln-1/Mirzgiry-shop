            ...
            <>
              <div key={historyIndex} className={s.history__wrapper}>
                <div className={s.history__order__number}>
                  № {history.count} от{' '}
                  {history.date.split('T')[0].split('-').reverse().join('.')}
                </div>
                ...
                <div>
                  ...
                  <svg
                    ...
                    className={
                      !opened ? s.history__icon__close : s.history__icon
                    }
                    width="10"
                    height="7"
                    viewBox="0 0 10 7"
              ...
              <div>
                {opened &&
                  history.basket?.map((product, indexProduct) => {
                    return (
              ...
              <div
                className={!opened ? s.history__close : s.history__information}
              >
                <div className={s.history__text__start}>
                  <p>
                    Имя Фамилия: {history.name} {history.surName}
                  </p>
                  <p>Спсосб доставки: {history.selectedRadio1}</p>
                </div>
                <div className={s.history__text__middle}>
                  <p>E-mail: {history.email}</p>
                </div>
                <div className={s.history__text__end}>
                  <p>Номер телефона: {history.phone}</p>
                  <p>Спсосб оплаты: {history.selectedRadio2}</p>
                </div>
              </div>
